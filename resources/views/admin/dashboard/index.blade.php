                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-2.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-3.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-4.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-7.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-8.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-9.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-10.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-11.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-12.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-13.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <img src="{{ url('assets/images/avatars/avatar-14.png') }}"
                                                        class="rounded-circle" width="46" height="46"
                                                        alt="" />
                                                </div>
                                                <div class="ms-2">
                ...
                <div class="card radius-10 w-100">
                    ...
                    <div class="customers-list p-3 mb-3">
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-3.png') }}" class="rounded-circle"
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-4.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-23.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-24.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-20.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-16.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-25.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-11.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-17.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{ url('assets/images/avatars/avatar-7.png') }}" class="rounded-circle"
                                    width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="recent-product-img">
                                            <img src="{{ url('assets/images/icons/headphones.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-2">
